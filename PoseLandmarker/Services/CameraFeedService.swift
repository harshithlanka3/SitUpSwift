...
class CameraFeedService: NSObject {
  ...
  /**
   This method switches between front and back camera.
   */
  func switchCameraPosition() {
    sessionQueue.async {
      ...
      // Remove existing video device input
      ...
      do {
        ...
        if self.session.canAddInput(videoDeviceInput) {
          ...
          // Update video orientation and mirroring for front camera
